...
4.1 通过BK服务器启动Agent
,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
在配网完成后，程序会调用 ``bk_sconf_trans_start()`` 向BK服务器请求启动Agent和启动设备端RTC，随后要求设备加入Agent所在房间，进行AI对话。
...
修改 ``/bk_ai/project/volc_rtc/config/bk7258/config`` 文件，通过将CONFIG_BK_DEV_STARTUP_AGENT=y开启本地启动Agent，通过CONFIG_VOLC_HTTP_STARTUP_AGENT=y，启动向自定义部署服务器启动Agent相关代码。
...
火山服务器启动Agent：https://github.com/volcengine/rtc-aigc-embedded-demo 
