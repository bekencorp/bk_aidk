...
We can download Armino AIDK SDK from gitlab::
    ...
    mkdir -p ~/armino
    cd ~/armino
    git clone http://gitlab.bekencorp.com/armino/bk_aidk.git
	

We also can download Armino AIDK SDK from github::

	mkdir -p ~/armino
	cd ~/armino
	git clone --recurse-submodules https://github.com/bekencorp/bk_aidk.git 
...
Run following commands to build BK7258 default agora_wanson_ai project::

    cd ~/armino/bk_aidk
    make bk7258


You can also build projects with PROJECT parameter, e.g. run "make bk7258 PROJECT=agora_ai" 
can build projects/agora_ai etc.
...
We can also use the project configuration file for differentiated configuration::
    ...
    + Example of project configuration file:
        projects/agora_wanson_ai/config/bk7258/config
...
The default project is projects/agora_wanson_ai. For new projects, please refer to the project in projects
